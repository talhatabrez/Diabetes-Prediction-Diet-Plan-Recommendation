...
root.title("Diabetes Prediction and Diet Plan Recommender")
...
def runANN():
    global ann
    global ann_acc
    ann = MLPClassifier(solver='sgd', alpha=1e-5,hidden_layer_sizes=(5, 2), random_state=1, max_iter=500)
...
font = ('times', 18, 'bold')
title = Label(root, text='Diabetes Prediction and Diet Plan Recommender')
title.config(bg='wheat', fg='brown')  
...
pathlabel.config(bg='red', fg='wheat')  
